    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 p-4">
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-2xl">
        ...
        <div className="text-center mt-6 flex justify-center space-x-4"> {/* Added flex and space-x for multiple buttons */}
          ...
          <button
            onClick={() => setView('userBookings')} // New button for User Bookings Page
  ...
  if (!session) {
    ...
    return (
      <>
        ...
        {view === 'userBookings' && <UserBookingsPage session={session} onLogout={handleLogout} setView={setView} />} {/* UserBookingsPage */}
      </>
    );
  }
}
